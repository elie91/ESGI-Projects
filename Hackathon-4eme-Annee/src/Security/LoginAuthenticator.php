...
class LoginAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if ($user){
            if (!$user->getActive())
                throw new CustomUserMessageAuthenticationException($this->translator->trans('user.error.active'));

            if ($user->getDeleted())
                throw new CustomUserMessageAuthenticationException($this->translator->trans('user.error.delete'));
        ...
        if (!$user) {
            throw new CustomUserMessageAuthenticationException($this->translator->trans('user.error.invalid'));
        }
