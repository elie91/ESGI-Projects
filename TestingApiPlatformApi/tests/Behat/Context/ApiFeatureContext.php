...
class ApiFeatureContext extends TestCase implements Context
{
    ...
    /**
     * @var object|\Symfony\Bundle\FrameworkBundle\Test\TestContainer|null
     */
    private $container;
    ...
    public function printLastResponseOnError(AfterScenarioScope $scope)
    {
        if ($scope->getTestResult()->getResultCode() == TestResult::FAILED) {
            ...
            OutputManager::printDebug(sprintf('<comment>%s</comment>: <info>%s</info>', $this->requestManager->getLastRequest()->getMethod(), $this->requestManager->getLastRequest()->getUri()) . "\n");
    ...
    public function thePropertyIsAString($property)
    {
        ...
        isType(
            'string',
            Utils::arrayGet($payload, $property, true),
